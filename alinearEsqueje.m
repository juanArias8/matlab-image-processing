function  esquejeAlineado = alinearEsqueje(esquejeBin)
    esquejeAlineado = imrotate(esquejeBin,180);
    figure(1);imshow(esquejeAlineado);
    title('Propiedades del esqueje sin alinear');
    prop = regionprops(esquejeAlineado,'all');
    N = length(prop);
    ...
    if v2(2)>0
        esquejeAlineado = imrotate(esquejeAlineado, -a2(7));
    else
        esquejeAlineado = imrotate(esquejeAlineado, a2(7));
    end
    esquejeAlineado = imrotate(esquejeAlineado,180);
end
